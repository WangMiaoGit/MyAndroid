...
import com.wang.myandroid.service.SmsService;
...
import static com.wang.myandroid.utils.ShareUtil.getBoolean;
...
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        boolean isSpeak = getBoolean( "isSpeak", false);
        sw_speak.setChecked(isSpeak);

        sw_sms = findViewById(R.id.sw_sms);
        sw_sms.setOnClickListener(this);

        boolean isSms = getBoolean( "isSms", false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.sw_speak:
                ...
                //保存状态
                ShareUtil.putBoolean( "isSpeak", sw_speak.isChecked());
                break;
            case R.id.sw_sms:
                //切换相反
                sw_sms.setSelected(!sw_sms.isSelected());
                //保存状态
                ShareUtil.putBoolean( "isSms", sw_sms.isChecked());
                if (sw_sms.isChecked()) {
                    //开启服务
