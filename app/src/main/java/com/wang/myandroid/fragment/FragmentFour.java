...
import com.wang.myandroid.ui.CourierActivity;
import com.wang.myandroid.ui.LoginActivity;
import com.wang.myandroid.ui.PhoneActivity;
...
public class FragmentFour extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        findView(view);
        UtilTools.getImageToShare(profile_image);
        return view;
    }
    ...
    private void findView(View view) {
        ...
        //初始化dialog  更换头像 弹出的底部  图库 拍照按钮 框
...
/*                MyUser.logOut();
 ...
 /*            //编辑资料
    ...
    public void onDestroy() {
        super.onDestroy();
        //保存
        UtilTools.putImageToShare(profile_image);
