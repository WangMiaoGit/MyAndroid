package com.wang.myandroid.service;
...
import com.wang.myandroid.view.DispatchLinearLayout;
...
public class SmsService extends Service implements View.OnClickListener {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (StaticClass.SMS_ACTION.equals(action)) {
                ...
                for (Object obj : objs) {
                    ...
                    LogUtil.i("短信的内容：" + smsPhone + ":" + smsContent);
                    showWindow();
                }
            }
        }
    ...
    //监听返回键 接口回调  用来分发事件  消除WindowManager
